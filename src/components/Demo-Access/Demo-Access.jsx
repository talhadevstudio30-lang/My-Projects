            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <h1 className="text-4xl font-bold text-gray-900 tracking-tight">
                  {projects.length > 0 && projects[0]?.latestDeployments?.[0]?.creator?.username
                    ? `${projects[0].latestDeployments[0].creator.username}'s Projects`
                    : 'Projects'}
                </h1>
                <p className="mt-2 text-lg text-gray-500">
                  {projects.length > 0 && projects[0]?.latestDeployments?.[0]?.creator?.username
                    ? `Hey ${projects[0].latestDeployments[0].creator.username} 👋 Ready to manage your Vercel deployments.`
                    : `Hey 👋 Ready to manage your Vercel deployments.`}
                </p>
              </div>
